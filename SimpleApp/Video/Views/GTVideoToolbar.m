...
- (void)layoutWithModel:(id)model {
	...
	_avatorImageView.image = [UIImage imageNamed:@"icons8-kawaii-croissant-50.png"];
	_nickLabel.text = @"Ancientear";

	_commentImageView.image = [UIImage imageNamed:@"icon.bundle/comment@3x.png.png"];
	_commentLabel.text = @"100";

	_likeImageView.image = [UIImage imageNamed:@"icon.bundle/praise@3x.png"];
	_likeLabel.text = @"25";

	_shareImageView.image = [UIImage imageNamed:@"icon.bundle/share@3x.png.png"];
	_shareLabel.text = @"分享";
